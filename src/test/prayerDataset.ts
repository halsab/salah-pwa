...
export function completeDataset(): PrayerDataset {
  const day: PrayerDay = { locationId: 'kazan', date: '2026-01-01', fajrStart: '02:21', fajrJamaat: '03:17', sunrise: '04:48', zenith: '11:44', dhuhr: '12:00', asr: '16:24', maghrib: '18:39', isha: '20:33' }
  return {
    schemaVersion: 2,
